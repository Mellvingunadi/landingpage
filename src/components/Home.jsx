          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-md bg-primary-foreground text-primary px-4 py-3 text-sm font-medium shadow-sm transition-colors hover:bg-[color:#248AD7] hover:text-[color:#ffff]"
                prefetch={false}
                target="_blank"
